				...
				<div class="row">
					<div class="col-lg-4">
						<div class="card">
							...
							<div class="card-body">
								<form method="POST" action="<?=SITEURL.'admin/locations/location/store';?>" id="form">
									<div class="row gy-4">
										...
										<div class="col-lg-12">
											<div class="input-group">
												<button class="btn btn-sm btn-primary submit" type="submit">Save Location</button>
											</div>
										</div>
									</div>
								</form>
					...
					<div class="col-lg-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title mb-0">Listing Location</h4>
							</div><!-- end card header -->
							<div class="card-body">
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12">
