												...
												<tbody>
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-2.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-7.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
																<div class="flex-grow-1">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-4.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
																<div class="flex-grow-1">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-5.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
																<div class="flex-grow-1">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-6.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
																<div class="flex-grow-1">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-1.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
																<div class="flex-grow-1">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center gap-1">
																<div class="flex-shrink-0">
																	<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/48/avatar-8.jpg" alt="" class="avatar-sm rounded-circle p-1">
																</div>
																<div class="flex-grow-1">
											...
											<table class="table table-borderless table-centered align-middle table-nowrap mb-0">
												...
												<tbody class="list">
													<tr>
														...
														<td class="shop">
															<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/companies/img-7.png" alt="" class="avatar-xxs rounded-circle">
														</td>
														<td class="customer">
															Alex Smith
														</td>
													...
													<tr>
														...
														<td class="shop">
															<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/companies/img-1.png" alt="" class="avatar-xxs rounded-circle">
														</td>
														<td class="customer">
															Jansh Brown
														</td>
													...
													<tr>
														...
														<td class="shop">
															<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/companies/img-2.png" alt="" class="avatar-xxs rounded-circle">
														</td>
														<td class="customer">
															Ayaan Bowen
														</td>
													...
													<tr>
														...
														<td class="shop">
															<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/companies/img-3.png" alt="" class="avatar-xxs rounded-circle">
														</td>
														<td class="customer">
															Prezy Mark
														</td>
													...
													<tr>
														...
														<td class="shop">
															<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/companies/img-4.png" alt="" class="avatar-xxs rounded-circle">
														</td>
														<td class="customer">
															Vihan Hudda
														</td>
													...
													<tr>
														...
														<td class="shop">
															<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/companies/img-5.png" alt="" class="avatar-xxs rounded-circle">
														</td>
														<td class="customer">
															Vihan Hudda
														</td>
											...
											<div class="vstack gap-2">
													...
													<div class="d-flex align-items-center gap-2">
														<div class="avatar-sm flex-shrink-0">
															<div class="avatar-title bg-light rounded">
																<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/products/32/img-1.png" alt="" class="avatar-xs">
															</div>
														</div>
														<div class="flex-grow-1">
															<a href="#!">
												...
												<div class="p-2 border border-dashed">
													<div class="d-flex align-items-center gap-2">
														<div class="avatar-sm flex-shrink-0">
															<div class="avatar-title bg-light rounded">
																<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/products/32/img-2.png" alt="" class="avatar-xs">
															</div>
														</div>
														<div class="flex-grow-1">
															<a href="#!">
												...
												<div class="p-2 border border-dashed">
													<div class="d-flex align-items-center gap-2">
														<div class="avatar-sm flex-shrink-0">
															<div class="avatar-title bg-light rounded">
																<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/products/32/img-3.png" alt="" class="avatar-xs">
															</div>
														</div>
														<div class="flex-grow-1">
															<a href="#!">
												...
												<div class="p-2 border border-dashed">
													<div class="d-flex align-items-center gap-2">
														<div class="avatar-sm flex-shrink-0">
															<div class="avatar-title bg-light rounded">
																<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/products/32/img-4.png" alt="" class="avatar-xs">
															</div>
														</div>
														<div class="flex-grow-1">
															<a href="#!">
												...
												<div class="p-2 border border-dashed">
													<div class="d-flex align-items-center gap-2">
														<div class="avatar-sm flex-shrink-0">
															<div class="avatar-title bg-light rounded">
																<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/products/32/img-5.png" alt="" class="avatar-xs">
															</div>
														</div>
														<div class="flex-grow-1">
															<a href="#!">
												...
												<div class="p-2 border border-dashed">
													<div class="d-flex align-items-center gap-2">
														<div class="avatar-sm flex-shrink-0">
															<div class="avatar-title bg-light rounded">
																<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/products/32/img-6.png" alt="" class="avatar-xs">
															</div>
														</div>
														<div class="flex-grow-1">
															<a href="#!">
										...
										<div data-simplebar class="px-3" style="max-height: 258px;">
											<div class="acitivity-timeline acitivity-main">
												...
												<div class="acitivity-item py-3 d-flex">
													<div class="flex-shrink-0">
														<img src="<?=BASEURL.DIR_SYSTEM.'admin-assets/';?>assets/images/users/32/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
													</div>
													<div class="flex-grow-1 ms-3">
